...
#AUTHOR : CHIGOZIEWORLDWIDE (TAP)
#OPEN SOURCE :)
#DON'T FORGET TO GIVE CREDIT TO TAP
...
header = {"user-agent": '[Mozilla/5.0 (Linux; Android 7.1.1; Moto E (4) Plus Build/NMA26.42-162-1) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/68.0.3440.85 Mobile Safari/537.36;]',
